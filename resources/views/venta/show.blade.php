...
@if ($cliente!= null)
    <h5 class="m-2">Datos del cliente</h5>
    <div class="card">
        <div class="card-body">
            <h4>ID= <small>{{ $cliente->id }}</small></h4>
            <h4>Ci: <small>{{ $cliente->CI}} </small></h4>
            <h4>Nit: <small>{{ $cliente->Nit }}</small></h4>
            <h4>Nombre: <small>{{ $cliente->Nombre }}</small> </h4>
            <h4>Apellido: <small>{{ $cliente->Apellido }}</small> </h4>
            <h4>Sexo: <small>{{ $cliente->Sexo }}</small> </h4>
            <h4>Celular: <small>{{ $cliente->elular }}</small> </h4>
        </div>
    </div>
@endif
@php
